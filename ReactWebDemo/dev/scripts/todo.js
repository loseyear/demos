...
/***/ function(module, exports, __webpack_require__) {
	...
	var LocalDb = __webpack_require__(159);

	var TodoHeader = __webpack_require__(160);
	var TodoMain = __webpack_require__(161);
	...
	var App = React.createClass({
	    ...
	    changeTodo: function changeTodo(index, isDone) {
	    ...
	    clearDone: function clearDone() {
	        ...
	        this.setState({ todos: todos, isAllChecked: false }, function () {
	            this.db.set('todos', this.state.todos);
	        });
	    },
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(TodoMain, {
	                todos: this.state.todos,
	                changeTodo: this.changeTodo,
	                deleteTodo: this.deleteTodo
	            }),
	            React.createElement(TodoFooter, _extends({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            this.props.todos.map(function (todo, index) {
	                return React.createElement(TodoItem, _extends({ key: index }, todo, { index: index }, _this.props));
	            })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoFooter = React.createClass({
	    ...
	    handleAll: function handleAll(event) {
	    ...
	    render: function render() {
	        var allChecked = this.props.isAllChecked || this.props.todoDoneCount === this.props.todoCount;
	        return React.createElement(
	            'footer',
	            null,
	            React.createElement('input', {
